import { createDatabase, findAvailableRoomTypes } from "@casa-marga/db";
import { availabilitySearchSchema, calculateStayTotalMinor, stayNights } from "@casa-marga/shared/booking";
