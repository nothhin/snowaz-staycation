...
export const metadata: Metadata = {
  title: "Privacy Notice | SnowAZ Staycation",
  description:
    "How SnowAZ Staycation handles guest and booking-request information.",
};
    ...
    <main className="legal-shell">
      ...
      <article className="legal-content">
        ...
        <section>
          ...
          <p>
            SnowAZ Staycation is responsible for the guest information submitted
        ...
        <section>
          ...
          <p>
            Access is limited to authorized SnowAZ personnel and service
        ...
        <section>
          ...
          <p>
            SnowAZ does not sell guest information. We do not use
            ...
            reasonably necessary to protect guests, SnowAZ, or the property.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            ...
            resolve disputes, and meet legal obligations. SnowAZ is finalizing
        ...
        <section>
          ...
          <p>
            ...
            Privacy Commission. Contact SnowAZ first using the details above so
