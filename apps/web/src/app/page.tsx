...
import { amenityHighlights, galleryImages, propertyProfile, stayHighlights } from "@/lib/property";
  ...
  return <main>
    <section className="snow-hero" id="home">
      ...
      <nav className="snow-nav" aria-label="Primary navigation">
        ...
        <div><a href="#gallery">Gallery</a><a href="#availability">Availability</a><a href="#location">Location</a><a href="#contact">Contact</a></div>
        <a className="gold-button" href="#availability">Book your stay</a>
      </nav>
      <div className="snow-hero-copy">
        <p>Premium urban living · Mandaue City</p>
    ...
    <section className="snow-section snow-intro">
      <div><p className="eyebrow">Welcome to SnowAZ</p><h2>Feel at home in the heart of the city.</h2></div>
      <p>Soft tones, warm gold details, and a comfortable setting come together in a private condo stay made for rest, connection, and happy memories.</p>
    </section>
    ...
    <section className="location-panel" id="location">
      <div><p className="eyebrow">In the heart of the city</p><h2>Urban convenience,<br />cozy comfort.</h2><address>{propertyProfile.address}</address><a className="text-link" href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(propertyProfile.address)}`} target="_blank" rel="noreferrer">Open in Google Maps →</a></div>
