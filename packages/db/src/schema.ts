...
export const bookingRequests = pgTable("booking_requests", {
  ...
  additionalGuestNightlyRateMinor: bigint("additional_guest_nightly_rate_minor", { mode: "number" }),
  parkingType: text("parking_type").notNull().default("none"),
  parkingNightlyRateMinor: bigint("parking_nightly_rate_minor", { mode: "number" }).notNull().default(0),
  parkingChargeMinor: bigint("parking_charge_minor", { mode: "number" }).notNull().default(0),
  ...
  lateCheckoutHourlyRateMinor: bigint("late_checkout_hourly_rate_minor", { mode: "number" }),
  priceVersion: bigint("price_version", { mode: "number" }),
